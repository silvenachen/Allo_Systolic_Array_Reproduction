...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.systolic_modulate.autotvin_v217.dat"
         "c.systolic_modulate.autotvin_v218.dat"
         "c.systolic_modulate.autotvin_v219.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.systolic_modulate.autotvout_v219.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
