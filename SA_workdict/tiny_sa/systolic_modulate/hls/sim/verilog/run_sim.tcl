...
if {[file isfile systolic_modulate.autotvin.dat]} {
	file delete -force systolic_modulate.autotvin.dat
}

if {[file isfile systolic_modulate.autotvout.dat]} {
	file delete -force systolic_modulate.autotvout.dat
}
