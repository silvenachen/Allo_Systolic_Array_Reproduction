...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.systolic_modulate.autotvin_v219.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.systolic_modulate.autotvout_v219.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 8;
parameter DEPTH = 32'd 192;
parameter DLY = 0.1;
