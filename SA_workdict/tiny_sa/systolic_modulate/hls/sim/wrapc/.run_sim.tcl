...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "systolic_modulate.autotvin.dat"
	set constFileTvOut       "systolic_modulate.autotvout.dat"
	set constFileHdlTvIn     "systolic_modulate.autohdltvin.dat"
	set constFileHdlTvOut    "systolic_modulate.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
